...
func TestRetryer_SuccessNoRetries(t *testing.T) {
	...
	result := retryer.DoResponse(ctx, func(ctx context.Context) resultext.Result[*http.Request, error] {
		req, err := http.NewRequestWithContext(ctx, "GET", server.URL, nil)
		if err != nil {
			return resultext.Err[*http.Request, error](err)
		}
		return resultext.Ok[*http.Request, error](req)
	}, http.StatusOK)
	...
	err := retryer.Do(ctx, func(ctx context.Context) resultext.Result[*http.Request, error] {
		req, err := http.NewRequestWithContext(ctx, "GET", server.URL, nil)
		if err != nil {
			return resultext.Err[*http.Request, error](err)
		}
