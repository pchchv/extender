...
//
// This is useful for when you wish to pass along values such as span or logging information but
// do not want the current operation to be cancelled despite what upstream code/callers think.
