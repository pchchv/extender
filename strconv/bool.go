...
// It extends the std library parse bool with a few more valid options.
//
...
func ParseBool(str string) (bool, error) {
	...
	case "", "0", "f", "F", "false", "FALSE", "False", "off", "no":
		return false, nil
	default:
		// strconv.NumError mimicking exactly the strconv.ParseBool(..) error and type to ensure compatibility with std library
